...
| [status](file:///e:/ws/mega/webserver/src/main/resources/templates/cs/dashboard.html#658-663) | VARCHAR(20) | **PROCESSED(학습대상)**, RECEIVED, FAILED |

> [!TIP]
> **RAG (현행화 학습)**: [status](file:///e:/ws/mega/webserver/src/main/resources/templates/cs/dashboard.html#658-663)가 `PROCESSED`인 데이터는 AI가 답변 초안을 작성할 때 "과거 사례"로서 검색 대상이 되어 답변 품질을 비약적으로 높여줍니다.
...
| [status](file:///e:/ws/mega/webserver/src/main/resources/templates/cs/dashboard.html#658-663) | VARCHAR(20) | PENDING(대기), PROCESSING(진행), COMPLETED(완료) |
...
3.  **Session Index**: `external_id`와 [status](file:///e:/ws/mega/webserver/src/main/resources/templates/cs/dashboard.html#658-663)에 인덱스가 걸려 있어 진행 중인 상담 세션을 빠르게 조회합니다.
